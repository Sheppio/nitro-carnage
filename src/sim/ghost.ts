...
export class LapTrace {
   ...
   */
  offer(t: number, x: number, z: number, yaw: number): void {
...
export function validTrace(data: unknown): data is number[] {
...
export function ghostAt(data: readonly number[], t: number): { x: number; z: number; yaw: number; speed: number } | null {
