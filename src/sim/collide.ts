...
export function resolveCarPair(
  a: RigidCapsule, b: RigidCapsule, shape: CapsuleShape, applyA = true, applyB = true, bounce = 0.3,
): { jx: number; jz: number; closing: number } | null {
  ...
  if (vn >= 0) return { jx: 0, jz: 0, closing: 0 };
