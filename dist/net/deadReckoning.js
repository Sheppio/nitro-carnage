 ...
 */
export function predict(p, dtSec, out) {
...
export class RemoteCar {
    ...
    errAt = 0;
    shown = { x: 0, z: 0, yaw: 0, vx: 0, vz: 0, y: 0 };
    tmp = { x: 0, z: 0, yaw: 0, vx: 0, vz: 0, y: 0 };
    /**
     * A new packet. Out-of-order ones (QoS 0 over a public broker guarantees
     * nothing) are dropped by their stamp.
     */
    receive(p, nowRoomMs, heardAt, teleport = false) {
        if (this.packet && p.t <= this.packet.t && !teleport)
            return;
