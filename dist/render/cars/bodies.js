...
function wedge(b, c) {
    ...
    for (let k = 0; k < 4; k++)
        b.box(0, 0.72, -1.05 - k * 0.2, 1.2, 0.04, 0.08, TRIM);
...
function buggy(b, c) {
    ...
    for (const [x, z] of [[0.55, 0.45], [-0.55, 0.45], [0.55, -0.85], [-0.55, -0.85]])
        b.box(x, 1.05, z, 0.09, 1.1, 0.09, tube);
 ...
 */
export function stripeColour(body, stripe) {
...
function stripes(b, look, deck, colour) {
